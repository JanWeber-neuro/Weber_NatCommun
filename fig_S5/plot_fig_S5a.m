function plot_fig_S5a(path)

% load data 
tbl = readtable(fullfile(path.data, 'SourceData.xlsx'), 'sheet', 'Fig_S5a');

freq  = table2array(tbl(1,2:end));

ga_0  = table2array(tbl(3:13,2:end));
ga_25 = table2array(tbl(17:27,2:end));
ga_75 = table2array(tbl(31:41,2:end));
