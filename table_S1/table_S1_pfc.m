...
for Isub = 1:numel(subjects)
    ...
    if ~isempty(tmpData.frontal.active)
        ...
        sortdata = squeeze(nanmean(tmpData.frontal.active.trial(idx,:,:),2));
...
set(gca, 'Clim', [0.5 3.5], 'linewidth', 3, 'fontsize', 13); box off
...
filename = 'table_S1_pfc_peaktiming.xlsx';
...
% write data into excelsheet
filename = 'table_S1_pfc_peakamp.xlsx';
writetable(table_data,filename, 'Sheet', 1);
