function plot_fig_4h_psi(path)

cb =  {'#008450', '#EFB700', '#B81D13'};

% load data 
tbl = readtable(fullfile(path.data, 'SourceData.xlsx'), 'sheet', 'Fig_4h');
...
h = rm_raincloud({ga_0, ga_25, ga_75}', [1 0 0], 0, 'ks', 0.5);
...
box off
set(gcf, 'Position', [579 293 231 204]);
