function plot_fig_2f_neurobehav_corr(path)

%% Correlation RT & Peak Amplitude

% load data 
tbl = readtable(fullfile(path.data, 'SourceData.xlsx'), 'sheet', 'Fig_2f upper right');
...
% load data 
tbl = readtable(fullfile(path.data, 'SourceData.xlsx'), 'sheet', 'Fig_2f lower right');
